document.addEventListener('DOMContentLoaded', function() {
  ...
  // Funzione per mostrare/nascondere la sidebar, ora accessibile globalmente
  window.toggleSidebar = function() {
    sidebar.classList.toggle('active');
  };

  // Funzione per il cambio pagina, ora accessibile globalmente
  ...
  // Funzione per il calcolo del rischio, ora accessibile globalmente
